        ...
        if not 'errors' in data_json :
            if len(data_json['Quotes']) != 0 :
                ...
                if not quotes_df.empty:
                    ...
                    #quotes_out_origin = quotes_cur_carrier.merge(places_df, left_on ='out_origin_id',right_on ='place_id', how='left')[['place_id','iata_code','city_name','country_name']]
                    #quotes_out_dest = quotes_cur_carrier.merge(places_df, left_on ='out_destination_id',right_on ='place_id', how='left')[['place_id','iata_code','city_name','country_name']]
